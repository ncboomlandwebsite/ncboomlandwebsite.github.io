$(function() {
  ...
  if ($(".audio-player").length) {
      ...
      [
        {
          title: "Afterburner",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\Afterburner.mp3"
        },
        {
          title: "Bet",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\Bet.mp3"
        },
        {
          title: "Domino Effect",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\Domino Effect.mp3"
        },
        {
          title: "Eyez",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\Eyez.mp3"
        },
        {
          title: "Sunrest",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\Sunrest.mp3"
        },
        {
          title: "Trap Anthem",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\Trap Anthem.mp3"
        },
        {
          title: "United",
          artist: "NC Boomin'",
          mp3: "..\\..\\NC BOOMLAND\\United.mp3"
        }
      ],
      {
        swfPath: "js/plugins",
    ...
    $("#js-subscribe-btn").on("click", function() {
      var firstName = $("#fname");
      var email = $("email");
      console.log("Fname: " + firstName.val() + ", Email: " + email.val());
    });
